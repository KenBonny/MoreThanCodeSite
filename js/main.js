jQuery(document).ready(function ($) {
    ...
    var valuesCarousel = $('.values-carousel');
    ...
    // value carousel pause functionality
    var isValuePlaying = true;
    var playValue = $('#play-values');
    playValue.click(function () {
        ...
        playValue.toggleClass('fa-pause');
    });

    // Mission carousel (uses the Owl Carousel library)
    var missionCarousel = $('.disciplines-carousel');
    ...
    // mission carousel pause functionality
    var isMissionPlaying = true;
    var playMission = $('#play-mission');
    playMission.click(function () {
        ...
        playMission.toggleClass('fa-pause');
    });

    // keep carousels paused after resize
    $(window).bind('afterResize', function(){
        var width = document.body.clientWidth;

        if (!isValuePlaying && width < 992) {
            valuesCarousel.trigger('stop.owl.autoplay');
        }
